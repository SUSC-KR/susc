---
univName: '숭실대학교'
univImg: '/images/univ/ssu/ssu.jpeg'
univDescription: '숭실대학교 동아리 리스트'
leadName: '윤재선'
viceLeadName: ['']
clubList: ['로보틱스']
---
...
<section class="bg-white dark:bg-gray-900">
	<div class="container px-6 py-10 mx-auto">
		...
		<p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">숭실대학교에서는 원활한 SUSC활동을 위해 아래의 구성원들이 고생해주고 있습니다.</p>

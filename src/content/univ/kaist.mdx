---
univName: 'KAIST'
univImg: '/images/univ/kaist/kaist.jpeg'
univDescription: 'KAIST 동아리 리스트'
leadName: ''
viceLeadName: ['']
clubList: ['SUSC KAIST']
---
...
<section class="bg-white dark:bg-gray-900">
	<div class="container px-6 py-10 mx-auto">
		...
		<p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">KAIST에서는 원활한 SUSC활동을 위해 아래의 구성원들이 고생해주고 있습니다.</p>
		<div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
			<UnivOrgCard 
				orgImg="/images/univ/kmou/org/yeonguk.webp"
				orgName="김재현"
				role="SUSC KAIST Ambassador"
